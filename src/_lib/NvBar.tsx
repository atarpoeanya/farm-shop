export default function NavBar() {
  return (
    <nav className="flex justify-between h-16">
      <div className="my-auto mx-2 flex flex-col items-center">
        <svg
          width="67"
          height="41"
          viewBox="0 0 67 41"
        ...
        <p className="text-xs font-serif">Malika Farm</p>
      </div>
      <div className="flex gap-6 items-center">
        ...
        <span>Tools</span>
        <span>Barn Products</span>
      </div>
      <div className="w-fit">
        <a href="/a/cart" className="h-full cart-button" id="cart">
          <svg
          ...
          <label htmlFor="cart" className="text-xs text-center">
            Cart
          </label>
        </a>
      </div>
